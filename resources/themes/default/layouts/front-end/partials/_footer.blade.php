        ...
        <div class="bg-white-overlay-50">
            <div class="container">
                <div class="d-flex flex-wrap end-footer footer-end last-footer-content-align">
                    <div class="mt-3">
                        <p class="text-align-direction __text-16px">{{ $web_config['copyright_text']->value }} | Website Designed By: <a href="https://www.facebook.com/mdarif.mehedi" target="_blank"><span style="color: white;">&nbsp;Marif IT</span></a></p>
                    </div>
                    <div
